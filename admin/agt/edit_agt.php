					...
					<div class="box-body">
						...
						<div class="form-group">
							...
							<select name="jenis_anggota" id="jenis_anggota" class="form-control" required>
                                ...
                                if ($data_cek['jenis_anggota'] == "Dosen") echo "<option value='Dosen' selected>Dosen</option>";
                                else echo "<option value='Dosen'>Dosen</option>";
                                
                                if ($data_cek['jenis_anggota'] == "Mahasiswa") echo "<option value='Mahasiswa' selected>Mahasiswa</option>";
